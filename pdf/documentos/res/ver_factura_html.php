...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from insumo, detalle_factura, facturas, categoria, insumo_marca,insumo_modelo where insumo.ID_INSUMO=detalle_factura.id_producto and detalle_factura.numero_factura=facturas.numero_factura 
and insumo.RELA_CATEGORIA=categoria.ID_CATEGORIA and insumo.RELA_INS_MARCA = insumo_marca.ID_INS_MARCA and insumo.RELA_INS_MODELO = insumo_modelo.ID_INS_MODELO and facturas.id_factura  = '".$id_factura."'");

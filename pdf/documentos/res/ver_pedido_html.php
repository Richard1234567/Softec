...
<?php
	$sumador_total=0;
$sql=mysqli_query($con, "select * from insumo, detalle_pedido, pedido_proveedor, categoria, insumo_marca,insumo_modelo where insumo.ID_INSUMO=detalle_pedido.id_producto and detalle_pedido.numero_pedido=pedido_proveedor.numero_pedido 
and insumo.RELA_CATEGORIA=categoria.ID_CATEGORIA and insumo.RELA_INS_MARCA = insumo_marca.ID_INS_MARCA and insumo.RELA_INS_MODELO = insumo_modelo.ID_INS_MODELO and pedido_proveedor.id_pedido ='".$id_pedido."'");

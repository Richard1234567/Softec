...
<?php 
    ...
    <?php
		$sumador_total=0;
		$sql=mysqli_query($con, "SELECT * FROM falla,precio, tmp_falla WHERE falla.ID_FALLA = tmp_falla.id_falla AND falla.RELA_PRECIO = precio.ID_PRECIO and tmp_falla.session_id  = '".$session_id."'");
	...
	?>
        ...
        <tr>
            <td style="width: 10%;text-align:center" class='midnight-blue'><?php echo $id_falla; ?></td>
...
$delete=mysqli_query($con,"DELETE FROM tmp_falla WHERE session_id='".$session_id."'");
?>
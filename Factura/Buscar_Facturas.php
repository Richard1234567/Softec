<?php 
	...
	$query = mysql_query("select * from facturas join persona on facturas.ID_PERSONA = persona.ID_PERSONA 
						  join operador on facturas.id_vendedor = operador.id 
						  join estado_factura on facturas.estado_factura = estado_factura.id_estado_factura where PERSONA_APELLIDO like '%$q%' or PERSONA_DNI like '%$q%' or PERSONA_NOMBRE like '%$q%';");
?>	
	<?php 

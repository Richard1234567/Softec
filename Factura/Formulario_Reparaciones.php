                ...
                <form class="form-horizontal" role="form" id="datos_factura">
                    ...
                    <div class="col-md-12">
                        <div class="pull-right">
                            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#myFallas">
...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/1.11.3/jquery.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        function falla(page){
            ...
            $.ajax({
                //url:'http://localhost/buscador/ajax/productos_fallas.php?action=page='+page+'&q='+q,
                url:'http://localhost/buscador/ajax/productos_fallas.php?action=ajax&page='+page+'&q='+q,
                 beforeSend: function(objeto){
                 $('#fallas').html('<img src="http://localhost/buscador/ajax/ajax-loader.gif"> Cargando...');
              },
                success:function(data){
                    $(".outer_fallas").html(data).fadeIn('slow');
                    $('#fallas').html('');

...
$resultado = mysql_query("SELECT * FROM insumo JOIN categoria ON RELA_CATEGORIA = ID_CATEGORIA JOIN insumo_marca ON RELA_INS_MARCA = ID_INS_MARCA JOIN insumo_modelo ON RELA_INS_MODELO = ID_INS_MODELO JOIN unidad_medida ON RELA_UNIDAD = ID_UNIDAD JOIN proveedor ON RELA_PROVEEDOR = ID_PROVEEDOR;") or mysql_error(($conexion));
?>
<html lang="es">
  <head>
    <meta charset="utf-8">
...
<form action="Reporte_Insumos.php">             
...
<script type="text/javascript" src="js/busca_fecha_insumos.js"></script>
<script type="text/javascript" src="js/imprimir_r_insumos.js"></script>
</body>
</html>
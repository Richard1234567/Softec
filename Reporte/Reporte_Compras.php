...
$resultado = mysql_query("SELECT * FROM compra JOIN tipo_comprobante ON RELA_COMPROBANTE = ID_COMPROBANTE;") or mysql_error(($conexion));
?>
<html lang="es">
  <head>
    <meta charset="utf-8">
...
<form action="Reporte_Compras.php">             
...
<script type="text/javascript" src="js/busca_fecha_compra.js"></script>
<script type="text/javascript" src="js/imprimir_r_compras.js"></script>
</body>
</html>
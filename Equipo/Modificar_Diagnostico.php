...
<?php  
  ...
  $Diagnóstico = $_POST['ID_DIAGNOSTICO'];
  ...
  //$sql_valores = "('".$Diagnóstico."','" .$valores. "','" .$Precio. "','" .$Estado. "')";
  $sql = "UPDATE `softec`.`diagnostico` SET `DIAGNOSTICO_DESC` = '$valores',
   `PRECIO_TOTAL` = '$Precio', 
   `RELA_ESTADO` = '$Estado' 
   WHERE `ID_DIAGNOSTICO` = '".$Diagnóstico."'";
  ...
  ?>  
    ...
    <td alingn="center"><button class="btn btn-success" style="width:1300px; margin: 150 0 0 30px;">El Diagnóstico fue Modificado con Éxito!.&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-ok" aria-hidden="true"></span></button></td>
    </tr>

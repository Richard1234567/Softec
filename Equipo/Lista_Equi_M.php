...
<?php
	...
	$strConsulta = "SELECT * FROM equipo join persona on RELA_PERSONA = ID_PERSONA 
                    join modelo on RELA_MODELO = ID_MODELO join marca on RELA_MARCA = ID_MARCA WHERE ID_PERSONA = '$pacientes';";
...
?>        
		<tr style="background: #fff;" align="center">
            ...
            <td>
            	<a href="http://localhost/buscador/Equipo/Diagnostico_Mo.php?id=<?php echo $fila['ID_EQUIPO'] ?>">

<?php 
	...
	$query = mysql_query("SELECT * FROM equipo JOIN persona ON RELA_PERSONA = ID_PERSONA JOIN marca ON RELA_MARCA = ID_MARCA JOIN modelo ON RELA_MODELO = ID_MODELO WHERE PERSONA_DNI LIKE '%$q%' OR PERSONA_APELLIDO LIKE '%q%' OR PERSONA_NOMBRE LIKE '%q%'");

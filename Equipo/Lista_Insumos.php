...
<h4 align="center">Filtrar Por Fechas</h4> <br>
 ...
 <br>
  ...
  <div id="filtro">
    <form action="Lista_Insumos.php" method="post">
      <table align="center">
        <tr align="center">
          <td><strong>Seleccionar Stock: &nbsp;</strong></td>
        <td><select name="filtro" class="form-control"><option value="todos">Seleccione un...</option><option value="bajo">Stock Bajo</option><option value="nada">Sin Stock</option></select></td>
          <td>&nbsp;<button class="btn btn-info">Filtrar</button></td>
        </tr>
      </table>
    </form>
  ...
  <div class="container-fluid">
    ...
    <div style="width: 97%; height: 31px; background: #EEEBEB; margin: 40 0 0 20px;">
      ...
      <input type="" placeholder="Buscar Producto" class="form-control" id="valor" onkeyup="Buscar()"; style="margin: -30 -90 0 1070px; width: 220px; height: 30px;">
    </div>
  </div><br>
...
?>    
    ...
    <script type="text/javascript" src="javascript/imprimir_productos.js"></script>
  </body>
</html> 
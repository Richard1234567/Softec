...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
		...
		<tr>
           <td style="width:50%;" >
			<?php 
				$sql_cliente=mysql_query("select * from persona where ID_PERSONA='$ID_PERSONA'");
				$rw_cliente=mysql_fetch_array($sql_cliente);
       ...
       <br>
		...
		<tr>
           <td style="width:35%;">
			<?php 
				$sql_user=mysql_query("select * from operador where ID_OPERADOR='$id_vendedor'");
...
$nums=1;
$sumador_total=0;
$sql=mysql_query( "select * from insumo, tmp where insumo.ID_INSUMO=tmp.id_insumo and tmp.session_id='".$session_id."'");
while ($row=mysql_fetch_array($sql))
	...
	$nombre_producto=$row['NOMBRE_INSUMO'];
	...
	$insert_detail=mysql_query("INSERT INTO detalle_factura VALUES ('','$numero_factura','$id_producto','$cantidad','$precio_venta_r')");
...
$insert=mysql_query("INSERT INTO facturas VALUES ('','$numero_factura','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','1')");
$delete=mysql_query("DELETE FROM tmp WHERE session_id='".$session_id."'");
?>
...
----------------------------*/
	...
	/*Inicia validacion del lado del servidor*/
	 if (empty($_POST['fecha'])){
		...
		$sql="INSERT INTO operador (FECHA_ALTA,APELLIDO_OPERADOR,NOMBRE_OPERADOR,DNI_OPERADOR, CORREO_OPERADOR,US_NOMBRE,US_PASSWORD,CLAVEPERMISO,OPERDOR_TEL,OPERADOR_CEL) VALUES ('".$fecha."','".$apellido."','".$nombre."', '".$dni."','".$correo."','".$usuario."','".$contraseña."','".$perfil."','".$telefono."','".$celular."'	)";

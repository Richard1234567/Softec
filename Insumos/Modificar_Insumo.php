...
<h3 align="center">Modificar Insumo</h3><br>

<form action="" method="post">
    
        <h4 align="center">Datos del Insumo</h4><br>
            ...
            <div class="row div" align="center">
              ...
              <div class="col-md-2"><label>Fec. Alta:</label></div>
              <div class="col-md-2"><input type="date" name="" class="form-control"></div>
            </div>
            <br>
            

            <div class="row div" align="center">
              <div class="col-md-3"><label>Nombre Insumo:</label></div>
              <div class="col-md-2"><input type="" name="" class="form-control"></div>
              <div class="col-md-2"><label>Cant. Insumo</label></div>
              <div class="col-md-2"><input type="" name="" class="form-control"></div>
            </div>
            <br>

            <div class="row div" align="center">
              <div class="col-md-3"><label>Precio Insumo:</label></div>
              <div class="col-md-2"><input type="" name="" class="form-control"></div>
              <div class="col-md-2"><label>Insumo Marca:</label></div>
              <div class="col-md-2"><select class="form-control">
                                    <option>Seleccione uno...</option>
                                    </select>
              </div>
              <div class="col-md-1"><label>Agregar</label><a href=""><img src="../Iconos PNG/add.png" class="icon-user1"></a></div>
            </div>
            <br>

            <div class="row div" align="center">
              <div class="col-md-3"><label>Insumo Modelo:</label></div>
              <div class="col-md-2"><select class="form-control">
                                    <option>Seleccione uno...</option>
                                    </select>
              </div>
            ...
            <div class="row div" align="center">
              ...
              <div class="col-md-2"><label>Tipo Insumo:</label></div>
              <div class="col-md-2"><select class="form-control">
                                    <option>Seleccione uno...</option>
                                    </select>
              </div>

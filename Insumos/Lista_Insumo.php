...
<form action="Lista_Insumo.php">
  ...
  <div class="container-fluid">
    ...
    <div style="margin: 2 0 -33 975px;">
      <td>
              <a href="actualizar_registros.php">
    ...
    <div style="margin: -10 0 -33 1200px;">
        <td>
    ...
    <div style="width: 99%; height: 31px; background: #EEEBEB; margin: 40 0 0 5px;">
...
?>    
          ...
          <div id='resultados'> 
            <div id="agrega-registros">
              ...
              <?php    
                ...
                $fecha=date("d/m/Y", strtotime($reg['FEC_ALTA']));
              ?>
    ...
    <script type="text/javascript" src="js/busca_insumo.js"></script>
    <script type="text/javascript" src="js/busca_fecha.js"></script>
    <script type="text/javascript" src="js/eliminar_insumo.js"></script>
    <script type="text/javascript" src="js/imprimir_insumos.js"></script>
  </body>
</html> 
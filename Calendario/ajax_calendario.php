...
switch ($_GET["accion"])
{
	...
	case "generar_calendario":
	{
		...
		echo "<table class='calendario' cellspacing='0' cellpadding='0'>";
			...
			echo "<p>&laquo; <a href='#' rel='$mesanterior' class='anterior'>Mes Anterior</a> - <a href='#' class='siguiente' rel='$messiguiente'>Mes Siguiente</a> - <a href='../Menu_Administrador.php'>Volver</a> &raquo; </p>";
		break;
	}
}
?>
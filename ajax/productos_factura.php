...
<div class="table-responsive">
	<table class="table" id="resultados">
		...
		<?php  
			...
			//$id_mano = $row['COD_INSUMO'];
			$mano = $row['INSUMO_NOMBRE'];
			$stock_producto=$row['INSUMO_CANTIDAD'];
			$precio_venta=$row["INSUMO_PRECIO"];
			//$precio_venta=number_format($precio_venta,3);
		...
		<tr>
			...
			<td class='col-xs-2'><input type="text" class="form-control" style="text-align:right" id="mano_<?php echo $id_producto; ?>" ></td>
			<td class='col-xs-2'><div class="pull-right">
			<input type="text" class="form-control" style="text-align:right" id="precio_total_r_<?php echo $id_producto; ?>"  value="<?php echo $precio_venta;?>" readonly>
			</div></td>

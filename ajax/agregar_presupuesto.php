...
{
$insert_tmp=mysql_query("INSERT INTO tmp_presupuesto (id_insumo,cantidad_tmp,precio_tmp,session_id) VALUES ('$id','$cantidad','$precio_total_r','$session_id')");

}
if (isset($_GET['id']))//codigo elimina un elemento del array
{
$id_tmp=intval($_GET['id']);	
$delete=mysql_query("DELETE FROM tmp_presupuesto WHERE id_tmp='".$id_tmp."'");
}
...
<form id="datos_factura_guardar">
	...
	<?php
		$sumador_total=0;
		//$descuento = 20;
		$sql=mysql_query("select * from insumo,categoria,insumo_marca, insumo_modelo, tmp_presupuesto where insumo.ID_INSUMO = tmp_presupuesto.id_insumo and insumo.RELA_CATEGORIA = categoria.ID_CATEGORIA and insumo.RELA_INS_MARCA =  insumo_marca.ID_INS_MARCA and insumo.RELA_INS_MODELO = insumo_modelo.ID_INS_MODELO and tmp_presupuesto.session_id= '".$session_id."'");

...
<?php
	...
	foreach($estrategias as $color){
      $valor = "".$color."";
      $colores_aux[] = $valor;
  	}
	  $valores = implode(', ', $colores_aux);
	  $sql_valores = "('".$Proveedor."','" .$valores. "')";
	  //echo $sql_valores;
	  //exit();

	  $sql = "INSERT INTO insumo_proveedor (id_proveedor,insumos) VALUES " .$sql_valores. ";";
    //echo $sql;
    //exit();
...
?>
		<tr class="table-info" align="center">
	      	<td alingn="center"><button class="btn btn-success" style="width:1300px; margin: 150 0 0 30px;">El Insumo del Proveedor fue dado de Alta con Éxito!.&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-ok" aria-hidden="true"></span></button>
	      	</td>
	    </tr>
<?php
